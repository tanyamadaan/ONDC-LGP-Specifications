...
async function readBuildFile(branchName) {
  ...
  const url = `https://api.github.com/repos/ONDC-Official/ONDC-LGP-Specifications/contents/ui/build.js?ref=${branchName}`;
...
async function loadContracts() {
  ...
  const BRANCHES_URL= "https://api.github.com/repos/ONDC-Official/ONDC-LGP-Specifications/branches";
  const TAGS_URL= "https://api.github.com/repos/ONDC-Official/ONDC-LGP-Specifications/tags";
